						...
						<c:when test="${filtro == 'todos' || filtro == null}">
							<c:forEach var="usuario" items="${usuarios}">
								<tr>
									...
									<td class="password">${usuario.clave}</td>
									<td>${usuario.run}</td>
									<c:choose>
										<c:when
											test="${usuario.getClass().getName().equals('cl.portafolio.Proyecto01.modelo.Administrativo')}">
										...
										<c:when
											test="${usuario.getClass().getName().equals('cl.portafolio.Proyecto01.modelo.Cliente')}">
											<td></td>
											<td></td>
