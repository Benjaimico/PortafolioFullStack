...
public class ImplClienteDao implements CRUD<Cliente> {
	...
	final String DELETE_CLIENTE = "DELETE usuario, cliente FROM usuario INNER JOIN cliente ON usuario.run = cliente.rutcliente WHERE usuario.run = ? AND usuario.clave = ?";
